...
public class CustomCheckBox extends View {
    ...
    public void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                setTickColorHex(a.getString(R.styleable.CustomCheckbox_tickColor));
                setTextColorHex(a.getString(R.styleable.CustomCheckbox_textColor));
                setShowOuterCircle(a.getBoolean(R.styleable.CustomCheckbox_showOuterCircle, true));
                setInnerCircleColorHex(a.getString(R.styleable.CustomCheckbox_innerCircleColor));
                setOuterCircleColorHex(a.getString(R.styleable.CustomCheckbox_outerCircleColor));
                setCircleBorderColorHex(a.getString(R.styleable.CustomCheckbox_circleBorderColor));
                setTickThickness(a.getDimension(R.styleable.CustomCheckbox_tickThickness, tickThickness));
                setBorderThickness(a.getDimension(R.styleable.CustomCheckbox_borderThickness, borderThickness));
                setTextLeftPadding(a.getDimension(R.styleable.CustomCheckbox_textLeftPadding, textLeftPadding));
                setTextSize(a.getDimension(R.styleable.CustomCheckbox_textSize, textSize));
                setInnerCircleRadius(a.getDimension(R.styleable.CustomCheckbox_innerCircleRadius, innerCircleRadius));
                setOuterCircleRadius(a.getDimension(R.styleable.CustomCheckbox_outerCircleRadius, outerCircleRadius));
                setText(a.getString(R.styleable.CustomCheckbox_text));
            } finally {
                a.recycle();
            }
        }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(CustomCheckBox view, boolean isChecked);
    }
